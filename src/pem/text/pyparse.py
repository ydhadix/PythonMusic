...
class Parser:
    """Lightweight, robust line-oriented scanner of Python source.

    Given a chunk of code, it tracks string/comment/bracket state without a full
    parse, so callers can ask "what's the indent of the statement containing this
    line?", "are we inside an unclosed bracket?", etc. -- used for auto-indent,
    block selection, and HyperParser.
    """
...
if __name__ == '__main__':
    ...
    main('pem.pem_test.test_pyparse', verbosity=2)
