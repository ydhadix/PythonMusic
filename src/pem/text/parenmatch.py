...
"""
from pem.text.hyperparser import HyperParser
...
class ParenMatch:
    ...
    @classmethod
    def reload(cls):
        cls.STYLE = pemConf.GetOption(
            'extensions','ParenMatch','style', default='opener')
        cls.FLASH_DELAY = pemConf.GetOption(
                'extensions','ParenMatch','flash-delay', type='int',default=500)
        cls.BELL = pemConf.GetOption(
                'extensions','ParenMatch','bell', type='bool', default=1)
        cls.HILITE_CONFIG = pemConf.GetHighlight(pemConf.CurrentTheme(),
                                                  'hilite')
...
if __name__ == '__main__':
    ...
    main('pem.pem_test.test_parenmatch', verbosity=2)
