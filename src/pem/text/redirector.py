"""Hook a Tk widget's own subcommands (insert, delete, ...) -- see WidgetRedirector."""
...
class WidgetRedirector:
    ...
    a text.insert call in pem code to have the same effect as a key press.
    ...
    In PEM, WidgetRedirector is used in Percolator to intercept Text
...
if __name__ == "__main__":
    ...
    main('pem.pem_test.test_redirector', verbosity=2, exit=False)
