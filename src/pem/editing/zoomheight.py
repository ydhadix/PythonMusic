...
class WmInfoGatheringError(Exception):
    "Raised when the window-manager geometry needed to compute the zoom can't be read."


class ZoomHeight:
    "Toggles a window between its normal height and full screen height."
...
if __name__ == "__main__":
    ...
    main('pem.pem_test.test_zoomheight', verbosity=2, exit=False)
