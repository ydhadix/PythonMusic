...
from pem.text.colorizer import color_config
...
class ViewWindow(Toplevel):
    "A simple text viewer dialog for PEM."
...
if __name__ == '__main__':
    ...
    main('pem.pem_test.test_textview', verbosity=2, exit=False)
