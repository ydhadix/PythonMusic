...
class GetKeysFrame(Frame):
    "The modifier checkboxes + key list for composing one accelerator (e.g. <Control-Key-s>)."
...
class GetKeysWindow(Toplevel):
    "Modal dialog wrapping GetKeysFrame; .result is the chosen binding or ''."
...
if __name__ == '__main__':
    ...
    main('pem.pem_test.test_config_key', verbosity=2, exit=False)
