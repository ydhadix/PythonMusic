"""Replace dialog for PEM. Inherits SearchDialogBase for GUI.
Uses pem.searchengine.SearchEngine for search capability.
...
from pem.searching.searchbase import SearchDialogBase
...
if __name__ == '__main__':
    ...
    main('pem.pem_test.test_replace', verbosity=2, exit=False)
