"""An PEM extension to avoid having very long texts printed in the shell.

A common problem in PEM's interactive shell is printing of large amounts of
text into the shell. This makes looking at the previous history difficult.
Worse, this can cause PEM to become very slow, even to the point of being
completely unusable.
        ...
        if self.is_dangerous:
            confirm = messagebox.askokcancel(
                ...
                message="\n\n".join([
                    ...
                    "Expanding it could make PEM slow or unresponsive.",
...
class Squeezer:
    ...
    This avoids PEM's shell slowing down considerably, and even becoming
    completely unresponsive, when very long outputs are written.
    """
    @classmethod
    def reload(cls):
        """Load class variables from config."""
        cls.auto_squeeze_min_lines = pemConf.GetOption(
...
if __name__ == "__main__":
    ...
    main('pem.pem_test.test_squeezer', verbosity=2, exit=False)
