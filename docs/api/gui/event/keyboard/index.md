...
|---|---|
| [`object.onKeyType(action)`](../../display/onKeyType.md) | Set up a function to call when a key is typed (pressed and released). |
...
| Function | Description |
|---|---|
| [`object.onKeyDown(action)`](../../display/onKeyDown.md) | Set up a function to call when a key is pressed down. |
| [`object.onKeyUp(action)`](../../display/onKeyUp.md) | Set up a function to call when a key is released. |
