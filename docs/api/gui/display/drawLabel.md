...
This draws to the canvas and returns nothing, which is fast and best for text you will not change later. To keep a handle you can move or delete, create a Label and [add()](add.md) it instead. Erase these drawings with [clearDrawing()](clearDrawing.md).
